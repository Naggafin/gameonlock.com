...
def get(self, request, *args, **kwargs):
    ...
    if (
        ...
        process_payment_confirmation.delay(txn_id=pdt_obj.txn_id, amount=pdt_obj.mc_gross, user_email=request.user.email if request.user.is_authenticated else None)
