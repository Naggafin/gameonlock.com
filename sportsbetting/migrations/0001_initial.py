# Generated by Django 5.1.4 on 2025-05-02 21:36
	...
	operations = [
		...
		migrations.CreateModel(
			...
			fields=[
				...
				("stakes", models.IntegerField(blank=True, editable=False, null=True)),
		...
		migrations.CreateModel(
			...
			options={
				"constraints": [
					...
					models.UniqueConstraint(
						condition=models.Q(("slug_name__isnull", False)),
						fields=("slug_name",),
		...
		migrations.AddField(
			...
			field=auto_prefetch.ForeignKey(
				on_delete=django.db.models.deletion.CASCADE,
				related_name="scheduled_games_away_teams",
		...
		migrations.AddField(
			...
			field=auto_prefetch.ForeignKey(
				on_delete=django.db.models.deletion.CASCADE,
				related_name="scheduled_games_home_teams",
				to="sportsbetting.team",
			),
		),
		migrations.AddField(
