	...
	operations = [
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					...
					models.OneToOneField(
						on_delete=django.db.models.deletion.CASCADE,
						related_name="under_over",
						to="sportsbetting.spreadentry",
					),
				),
				(
					"ticket",
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					...
					models.ForeignKey(
						on_delete=django.db.models.deletion.CASCADE,
						related_name="under_over_picks",
						to="sportsbetting.ticketplay",
					),
				),
				(
					"under_over_entry",
					models.ForeignKey(
						on_delete=django.db.models.deletion.CASCADE,
						related_name="picks",
						to="sportsbetting.underoverentry",
					),
				),
			],
		),
		...
		migrations.AddConstraint(
			...
			constraint=models.UniqueConstraint(
				fields=("play", "under_over_entry"), name="unique_under_over_pick"
			),
		),
		migrations.AddConstraint(
			model_name="spreadpick",
			constraint=models.UniqueConstraint(
				fields=("play", "spread_entry"), name="unique_spread_pick"
			),
		),
	]
