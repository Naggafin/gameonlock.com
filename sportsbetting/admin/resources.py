...
from ..models import BettingLine, Game, GoverningBody, Team
...
class GameResource(resources.ModelResource):
	...
	def before_import_row(self, row, **kwargs):
		...
		required_fields = ["governing_body", "home_team", "away_team", "commence_time"]
...
class BettingLineResource(resources.ModelResource):
	...
	def after_import_row(self, row, row_result, **kwargs):
		...
		governing_body_name = row.get("governing_body", "")
		...
		row["game"] = result.rows[0].instance
