...
from sportsbetting.models import Sport, GoverningBody, Team, Game, BettingLine
...
def create_common_test_data():
    ...
    team1 = Team.objects.create(name="Team 1", downloaded=False, governing_body=gov_body)
    team2 = Team.objects.create(name="Team 2", downloaded=False, governing_body=gov_body)
