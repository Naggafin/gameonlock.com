...
from sportsbetting.models import Team, Game, BettingLine
from sportsbetting.admin import TeamResource, GameResource, BettingLineResource
...
class AdminImportExportTests(TestCase):
    ...
    def test_team_export(self):
        ...
        self.assertEqual(dataset.headers, ['id', 'name', 'external_id', 'website', 'location', 'founding_year', 'downloaded'])
    ...
    def test_game_export(self):
        ...
        self.assertEqual(dataset.headers, ['id', 'external_id', 'home_team', 'away_team', 'start_time', 'status', 'home_score', 'away_score', 'updated_at'])
    ...
    def test_betting_line_export(self):
        ...
        self.assertEqual(dataset.headers, ['id', 'game', 'home_spread', 'over_under', 'updated_at'])
    ...
    def test_team_import_valid_data(self):
        ...
        writer.writerow(['id', 'name', 'external_id', 'website', 'location', 'founding_year', 'downloaded'])
        writer.writerow(['', 'Team 3', 'T3', 'http://team3.com', 'City 3', '1990', 'False'])
    ...
    def test_betting_line_import_invalid_data(self):
        ...
        self.assertEqual(BettingLine.objects.count(), 1)  # No new betting line should be added
    ...
    def test_admin_access_betting_line_import_export_page(self):
        ...
        response = self.client.get(reverse('admin:sportsbetting_bettingline_changelist'))
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, "Import")
        self.assertContains(response, "Export")